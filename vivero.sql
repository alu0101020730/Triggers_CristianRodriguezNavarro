...
CREATE TABLE IF NOT EXISTS `mydb`.`ZONA_has_PRODUCTO` (
  `ZONA_NUMERO_ZONA` INT NOT NULL,
  `PRODUCTO_COD.BARRAS` INT NOT NULL,
  PRIMARY KEY (`ZONA_NUMERO_ZONA`, `PRODUCTO_COD.BARRAS`),
  INDEX `fk_ZONA_has_PRODUCTO_PRODUCTO1_idx` (`PRODUCTO_COD.BARRAS` ASC)  ,
  INDEX `fk_ZONA_has_PRODUCTO_ZONA1_idx` (`ZONA_NUMERO_ZONA` ASC)  ,
